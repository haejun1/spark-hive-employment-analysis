...
- 데이터 수집
    - VS Code 환경에서 beautifulsoup를 활용하여 {점핏} 사이트의 채용 공고문 데이터를 수집한다
...
### 참고자료 및 AI 도구
- 빅데이터 프로그래밍 pdf 자료
- velog : [GCP] VS Code로 로컬 서버와 GCP 서버 연결하기

- 사용 AI : Gemini 3.5 Flash
- 주요 사용 방식: 
    1. 전처리 전 핵심 도메인 키워드 1차 추출하여 전처리 성능 향상
    2. 자동화 방식 설계 및 설정
    3. 가상환경 및 데이터 기술 vscode에서 세팅 및 연결
    4. 데이터 수집, 처리 과정에서 오류 해결
    5. 시각화 및 발표자료 생성
